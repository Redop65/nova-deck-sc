...
def test_frontend_assets_revalidate_after_updates() -> None:
    ...
    assert "app.js?v=1.2.2-visual-polish" in index.text
    assert "styles.css?v=1.2.2-visual-polish" in index.text
    assert "themes.css?v=1.2.2-visual-polish" in index.text
